...
from crud import get_users, get_user_by_telegram_uid, create_user, update_user, login, logout
...
@app.get("/users/{telegram_uid}", response_model=UserCreate)
...
"""Update user"""
@app.put("/users/{telegram_uid}", response_model=UserUpdate)
